...
parser_io.add_argument('-o', default='', help='output base_name')
parser_io.add_argument('-b', type=argparse.FileType('r'), help='Background file to add percentage to legend')
parser_io.add_argument('--nr', action='store_true', help='Second pos is ribo')
parser_io.add_argument('--mono', action='store_true', help='Input is mononucleotide')
parser_io.add_argument('--tri', type=int, default=0, help='Input is trinucleotide, with the position')
...
parser_h.add_argument('--legend_group', default=0, choices=[0,4,16], type=int, help='Group size of legend, choices=[0,4,16], 0 means all, default=0')
parser_h.add_argument('--no_annot', action='store_true', help='Hide percentage annotation for heatmap')
parser_h.add_argument('--cmax', type=float, default=0.5, help='Maximum color scale')
